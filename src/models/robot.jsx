...
const Robot = (props) => {
 ...
 // 🔁 Animate rotation or movement
  useFrame((state, delta) => {
    if (group.current) {
      group.current.rotation.y += delta * 0.5     // spin slowly
      group.current.position.y = Math.sin(state.clock.elapsedTime) * 0.2 // bob up and down
    }
  })
